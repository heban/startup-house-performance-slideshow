...
export default function TypeScriptUsage() {
  return (
    <Box>
      <ParagraphBox>
        {LABELS.map(label => (
      ...
      <PieChart
        data={[
          { title: LABELS[0].title, value: 46.7, color: LABELS[0].color },
          { title: LABELS[1].title, value: 5.4, color: LABELS[1].color },
          { title: LABELS[2].title, value: 33.7, color: LABELS[2].color },
          { title: LABELS[3].title, value: 13.7, color: LABELS[3].color },
          { title: LABELS[4].title, value: 1, color: LABELS[4].color },
        ]}
        style={{height: '400px'}}
        animate
