...
export default function StyledUsage() {
  return (
    <Box>
      ...
      <PieChart
        data={[
          { title: LABELS[0].title, value: 33.2, color: LABELS[0].color },
          { title: LABELS[1].title, value: 5.9, color: LABELS[1].color },
          { title: LABELS[2].title, value: 26.2, color: LABELS[2].color },
          { title: LABELS[3].title, value: 12.5, color: LABELS[3].color },
          { title: LABELS[4].title, value: 20.7, color: LABELS[4].color },
        ]}
        style={{height: '400px'}}
        animate
