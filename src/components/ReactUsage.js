...
export default function ReactUsage() {
  return (
    <Box>
      ...
      <PieChart
        data={[
          { title: LABELS[0].title, value: 64.8, color: LABELS[0].color },
          { title: LABELS[1].title, value: 6.7, color: LABELS[1].color },
          { title: LABELS[2].title, value: 19.1, color: LABELS[2].color },
          { title: LABELS[3].title, value: 9.2, color: LABELS[3].color },
        ]}
        style={{height: '400px'}}
        animate
