...
export default function ReactNativeUsage() {
  return (
    <Box>
      <ParagraphBox>
        {LABELS.map(label => (
      ...
      <PieChart
        data={[
          { title: LABELS[0].title, value: 18.7, color: LABELS[0].color },
          { title: LABELS[1].title, value: 3.6, color: LABELS[1].color },
          { title: LABELS[2].title, value: 53.2, color: LABELS[2].color },
          { title: LABELS[3].title, value: 22.2, color: LABELS[3].color },
          { title: LABELS[4].title, value: 2.3, color: LABELS[4].color },
        ]}
        style={{height: '400px'}}
        animate
